...
F('bagel-in', 'BAGEL input file', '1F',
  module='bagel', ext='bgi'),
F('bagel-out', 'BAGEL output file', '1F',
  module='bagel', ext='bgo',
  magic=b'*BAGEL - Freshly leavened quantum chemistry'),
