...
### Tests for VibrationsData object

from ase import units
from ase.vibrations.vibrations import VibrationsData
from numpy.testing import assert_array_almost_equal

vib_data = VibrationsData(Atoms('N2', positions=[[0., 0., 0.05095057],
                                                 [0., 0., 1.04904943]]),
                          np.array([[[[ 4.67554672e-03,  0.0,  0.0],
...
assert_array_almost_equal(freqs, energies / units.invcm, decimal=5)
