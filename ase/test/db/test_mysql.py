...
def url():
    ...
    if on_ci_server:
        # CI server configured to use non-standard port 3307 instead of the default 3306 port
        # This tests for proper passing of the port for creating the mysql connection
